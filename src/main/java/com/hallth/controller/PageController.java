...
public class PageController {
    ...
    @RequestMapping(value="/toDatabaseOperation", method = {RequestMethod.GET, RequestMethod.POST})
    public String toDatabaseOperation(HttpServletRequest request, Model model){
